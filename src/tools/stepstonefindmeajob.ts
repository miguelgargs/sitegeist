...
import { STEPSTONEFINDMEAJOB_TOOL_DESCRIPTION } from "../prompts/prompts.js";
...
async function getBaseUrl(): Promise<string> {
	...
	const stored = await settings.get("stepstonefindmeajobBaseUrl");
...
const stepstonefindmeajobParamsSchema = Type.Object({
...
type StepstoneFindMeAJobParams = Static<typeof stepstonefindmeajobParamsSchema>;

export const stepstonefindmeajobTool: AgentTool<typeof stepstonefindmeajobParamsSchema, any> = {
	label: "StepstoneFindMeAJob",
	name: "stepstonefindmeajob",
	description: STEPSTONEFINDMEAJOB_TOOL_DESCRIPTION,
	parameters: stepstonefindmeajobParamsSchema,
	execute: async (
		_toolCallId: string,
		args: StepstoneFindMeAJobParams,
		_signal?: AbortSignal,
...
// Renderer
interface StepstoneFindMeAJobResultDetails {
	operation?: string;
	status?: number;
	data?: any;
}

export const stepstonefindmeajobRenderer: ToolRenderer<StepstoneFindMeAJobParams, StepstoneFindMeAJobResultDetails> = {
	render(
		params: StepstoneFindMeAJobParams | undefined,
		result: ToolResultMessage<StepstoneFindMeAJobResultDetails> | undefined,
	): ToolRenderResult {
...
registerToolRenderer(stepstonefindmeajobTool.name, stepstonefindmeajobRenderer);
